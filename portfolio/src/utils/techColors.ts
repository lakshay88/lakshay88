...
export const getTechColor = (techName: string): { bg: string; text: string; icon: string } => {
  const colorMap: Record<string, { bg: string; text: string; icon: string }> = {
    ...
    'Golang': { bg: '#181818', text: '#ffffff', icon: '#00ADD8' },
    'Python': { bg: '#181818', text: '#ffffff', icon: '#3776AB' },
    'FastAPI': { bg: '#181818', text: '#ffffff', icon: '#059669' },
    ...
    'REST APIs': { bg: '#181818', text: '#ffffff', icon: '#ffffff' },
