...
const chapters = [
  ...
  {
    code: '02 / HIGH-THROUGHPUT MIDDLEWARE & CONCURRENCY',
    company: 'Zoop.one Ltd',
    title: 'High-throughput middleware and concurrent worker pools',
    description: 'Engineering resilient challan payment middleware and high-performance worker pools in Golang using goroutines and channels to maximize system throughput and resource efficiency.',
    signals: ['Golang Goroutines', 'Worker Pools', 'Payment Middleware', 'Service Layer Testing'],
  },
  {
    code: '03 / DISTRIBUTED FINTECH PLATFORMS & CI/CD',
    company: 'Sigma Infosolutions Ltd',
    title: 'Loan origination systems, graph databases, and 3rd-party integrations',
    description: 'Scaling Loan Origination System (LOS) applications with Golang, Dgraph graph databases, and third-party fintech integrations (Plaid, Persona), paired with automated Jenkins CI/CD pipelines.',
    signals: ['Golang & gRPC', 'Dgraph & MySQL', 'RabbitMQ & Redis', '70% Faster CI/CD'],
  },
  {
    code: '04 / DEVELOPER TOOLS & OPEN SOURCE',
